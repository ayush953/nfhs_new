...
@Component({
  selector: 'app-childrens-weight-heaping-first-decimal',
  templateUrl: './childrens-weight-heaping-first-decimal.component.html',
  styleUrls: ['./childrens-weight-heaping-first-decimal.component.scss']
})
export class ChildrensWeightHeapingFirstDecimalComponent 
{
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllChildrensWeightHeapingFirstDecimal());
  }
