...
@Component({
  selector: 'app-mens-weight-heaping-second-decimal-teamwise',
  templateUrl: './mens-weight-heaping-second-decimal-teamwise.component.html',
  styleUrls: ['./mens-weight-heaping-second-decimal-teamwise.component.scss']
})
export class MensWeightHeapingSecondDecimalTeamwiseComponent 
{
...
this.getdata();
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllMensWeightHeapingSecondDecimalTeamwise(this.stateId));
  }
