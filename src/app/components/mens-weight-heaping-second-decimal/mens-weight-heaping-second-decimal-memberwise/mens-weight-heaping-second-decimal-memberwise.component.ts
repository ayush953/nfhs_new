...
@Component({
  selector: 'app-mens-weight-heaping-second-decimal-memberwise',
  templateUrl: './mens-weight-heaping-second-decimal-memberwise.component.html',
  styleUrls: ['./mens-weight-heaping-second-decimal-memberwise.component.scss']
})
export class MensWeightHeapingSecondDecimalMemberwiseComponent 
{
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllMensWeightHeapingSecondDecimalMemberwise(this.stateId,this.teamNo));
  }
