...
@Component({
  selector: 'app-mens-weight-heaping-first-decimal-teamwise',
  templateUrl: './mens-weight-heaping-first-decimal-teamwise.component.html',
  styleUrls: ['./mens-weight-heaping-first-decimal-teamwise.component.scss']
})
export class MensWeightHeapingFirstDecimalTeamwiseComponent 
{
...
this.getdata();
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllMensWeightHeapingFirstDecimalTeamwise(this.stateId));
  }
