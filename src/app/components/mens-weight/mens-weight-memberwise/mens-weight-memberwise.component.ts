...
@Component({
  selector: 'app-mens-weight-memberwise',
  templateUrl: './mens-weight-memberwise.component.html',
  styleUrls: ['./mens-weight-memberwise.component.scss']
})
export class MensWeightMemberwiseComponent 
{
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllMensWeightMemberwise(this.stateId,this.teamNo));
  }
