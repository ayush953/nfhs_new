...
@Component({
  selector: 'app-mens-weight',
  templateUrl: './mens-weight.component.html',
  styleUrls: ['./mens-weight.component.scss']
})
export class MensWeightComponent 
{
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllMensWeight());
  }
