...
@Component({
  selector: 'app-childrens-weight-teamwise',
  templateUrl: './childrens-weight-teamwise.component.html',
  styleUrls: ['./childrens-weight-teamwise.component.scss']
})
export class ChildrensWeightTeamwiseComponent 
{
...
this.getdata();
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllChildrensWeightTeamwise(this.stateId));
  }
